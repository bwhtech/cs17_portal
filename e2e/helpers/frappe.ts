...
export const SITE_HOST = process.env.SITE_HOST || "cs17.portal:8000";
 ...
 * scoped to the site domain (cs17.portal), so they won't be sent automatically.
 */
function getAuthCookies(): string {
	if (cookieCache !== null) {
		return cookieCache as string;
	}
...
/**
 * Call a Frappe whitelisted GET method.
 */
